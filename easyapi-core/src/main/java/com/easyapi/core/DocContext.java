...
import com.easyapi.core.constant.ProjectType;
...
public class DocContext {
    ...
    public static File getLogFile() {
        return new File(DocContext.getDocPath(), "easyapi.log");
    }
    ...
    private static void setDocPath(DocsConfig config) {
        if (config.docsPath == null || config.docsPath.isEmpty()) {
            config.docsPath = projectPath + "easuapi";
        }
