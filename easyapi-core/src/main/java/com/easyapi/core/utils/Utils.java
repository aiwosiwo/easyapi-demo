...
import com.easyapi.core.constant.BuildToolTypeEnum;
...
public class Utils {
    ...
    public static File getThirdPartJarFile(String fileName, String filePath) {
        String jarPath = getJarPath() + File.separator + CoreConstants.JAR_PATH;
        String targetPath;
        if (filePath != null) {
            fileName = filePath + File.separator + fileName;
            targetPath = DocContext.getDocPath() + File.separator + fileName;
        } else {
            targetPath = System.getProperty(CoreConstants.USER_DIR) + File.separator + fileName;
        }
